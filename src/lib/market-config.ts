...
export const MARKET_CONFIG: Record<string, AssetConfig> = {
    ...
    // COMMODITIES
    'XAU': { ticker: 'GC=F', type: 'commodity', leverageMax: 50, name: 'Gold', description: 'Gold Futures', pythPriceId: '0x765d2ba906dbc32ca17cc11f5310a89e9ee1f6420508c63861f2f8ba4ee34bb2', icon: '/images/commodities/XAU.png' },
    'XAG': { ticker: 'SI=F', type: 'commodity', leverageMax: 50, name: 'Silver', description: 'Silver Futures', pythPriceId: '0xf2fb02c32b055c805e7238d628e5e9dadef274376114eb1f012337cabe93871e', icon: '/images/commodities/XAG.png' },
    'WTI': { ticker: 'CL=F', type: 'commodity', leverageMax: 50, name: 'Crude Oil', description: 'WTI Crude Oil Futures', pythPriceId: '0x925cb2410a56f082e057f9235e2373df899f84826a760f3844f227b49466b3e6', icon: '/images/commodities/WTI.png' },
    'BRENT': { ticker: 'BZ=F', type: 'commodity', leverageMax: 50, name: 'Brent Crude', description: 'Brent Crude Oil Futures', pythPriceId: '0x27f08c37d8009b02a573216827050543597c36a49591e1d053228c24d86407d5', icon: '/images/commodities/BRENT.png' },
    'NG': { ticker: 'NG=F', type: 'commodity', leverageMax: 50, name: 'Natural Gas', description: 'Natural Gas Futures', icon: '/images/commodities/NG.png' },
    'ZC':  { ticker: 'ZC=F', type: 'commodity', leverageMax: 50, name: 'Corn', description: 'Corn Futures', icon: '/images/commodities/ZC.png' },
    'ZW':  { ticker: 'ZW=F', type: 'commodity', leverageMax: 50, name: 'Wheat', description: 'Wheat Futures', icon: '/images/commodities/ZW.png' },
    'HG':  { ticker: 'HG=F', type: 'commodity', leverageMax: 50, name: 'Copper', description: 'Copper Futures', icon: '/images/commodities/HG.png' },
    'ZW-SOY': { ticker: 'ZS=F', type: 'commodity', leverageMax: 50, name: 'Soybeans', description: 'Soybean Futures', icon: '/images/commodities/ZW-SOY.png' },
    'KC':  { ticker: 'KC=F', type: 'commodity', leverageMax: 50, name: 'Coffee', description: 'Coffee Futures', icon: '/images/commodities/KC.png' },
    'SB':  { ticker: 'SB=F', type: 'commodity', leverageMax: 50, name: 'Sugar', description: 'Sugar Futures', icon: '/images/commodities/SB.png' },
    'CT':  { ticker: 'CT=F', type: 'commodity', leverageMax: 50, name: 'Cotton', description: 'Cotton Futures', icon: '/images/commodities/CT.png' },
    'RBOB': { ticker: 'RB=F', type: 'commodity', leverageMax: 50, name: 'Gasoline', description: 'RBOB Gasoline Futures', icon: '/images/commodities/RBOB.png' },
    'HO':   { ticker: 'HO=F', type: 'commodity', leverageMax: 50, name: 'Heating Oil', description: 'Heating Oil Futures', icon: '/images/commodities/HO.png' },
    'AL':   { ticker: 'ALI=F', type: 'commodity', leverageMax: 50, name: 'Aluminium', description: 'Aluminium Futures', icon: '/images/commodities/AL.png' },
    'ZN':   { ticker: 'ZNC=F', type: 'commodity', leverageMax: 50, name: 'Zinc', description: 'Zinc Futures', icon: '/images/commodities/ZN.png' },
    'NI':   { ticker: 'NICK=F', type: 'commodity', leverageMax: 50, name: 'Nickel', description: 'Nickel Futures', icon: '/images/commodities/NI.png' },
    'COCOA': { ticker: 'CC=F', type: 'commodity', leverageMax: 50, name: 'Cocoa', description: 'Cocoa Futures', icon: '/images/commodities/COCOA.png' },
